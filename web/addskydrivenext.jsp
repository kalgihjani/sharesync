...
<html>
    <head>
        ...
        <title>add Skydrive</title>
    <script src="SpryAssets/SpryValidationTextField.js" type="text/javascript"></script>
    <link href="SpryAssets/SpryValidationTextField.css" rel="stylesheet" type="text/css">
    </head>
    <body>
        <form name="form1" method="post" action="addskydrivenext">
          <p>enter your Sky drive account : 
            <label for="textfield"></label>
            <span id="sprytextfield1">
            <input name="skyaccount" type="text" id="textfield" size="50">
          ...
          <p>Enter the folder drive folder name you wanted to keep sync: 
            ...
            <input type="text" name="skyfolder" id="textfield2">
          </p>
          <p>
